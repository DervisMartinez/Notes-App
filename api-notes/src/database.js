...
const userTableColumns = "USER_ID INT NOT NULL AUTO_INCREMENT,GOOGLE_ID VARCHAR(20),FIRST_NAME VARCHAR(50), LAST_NAME VARCHAR(120), EMAIL VARCHAR(50), PASSWORD VARCHAR(200), PRIMARY KEY (USER_ID)"
